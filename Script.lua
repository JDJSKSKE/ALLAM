...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@source_allam"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : مـاكـس](t.me/@source_allam)',nil,inline,msg.id_)
return false
end
...
💯╽المطور » مطور البوت
┄─┅═ـ═┅─┄
 ‏‎‏💭│رآسـلني للآسـتفسـآر ☜ { ]]..SUDO_ @FACKYOOOOOU..[[ } ✓ ]]
end
...
┄─┅═ـ═┅─┄
💭*│* راسلني للاستفسار 💡↭ ]]..SUDO_ @FACKYOOOOOU
...
return [[
┄─┅══┅─┄     
👋│اهلا بك في سورس علام 😍
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
📡╿[قناة السورس](t.me/source_allam)
⚜│[قناة شروحات السورس](t.me/source_allam)
🤖│[بوت تواصل](t.me/A_L_L_A_Mbot)
👨🏻‍✈️╽[مطور السـورس](t.me/@FACKYOOOOOU)
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
...
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
 ⚖│مـعـرف الـمـطـــور ↫ ]]..SUDO_ @FACKYOOOOOU..[[
]]
else
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(max..':NameBot:')..[[] 🗽
⛓│ آختـصاصـي حمايـه آلمجـموعـات ..
...
local inline = {{{text="مـطـور الـبـوت ✓",url="t.me/@FACKYOOOOOU"..xsudouser}}}
...
🎭│مـعـرف الـمـطـور  : ]]..SUDO_ @FACKYOOOOOU:gsub([[\_]],'_')..[[ 🌿
]])
return false
end 
...
elseif Text== "عمري" then return sendMsg(msg.chat_id_,msg.id_,"خلصته دياحه وزحف 🌝🌿 ")
 elseif Text== "المطور" then return sendMsg(msg.chat_id_,msg.id_," @FACKYOOOOOU ")
