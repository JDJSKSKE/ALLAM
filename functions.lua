...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(allam..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(allam..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
elseif redis:sismember(allam..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(allam..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(allam..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(allam..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(allam..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(allam..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(allam..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(allam..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(allam..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(allam..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(allam..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(allam..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(allam..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(allam..':SUDO_BOT:')
...
local monsha = redis:smembers(allam..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
message = message .."♦️│Not Creator ~⪼ لا يوجد منشئيين !\n"
else
for k,v in pairs(monsha) do
local info = redis:hgetall(allam..'username:'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
message = message ..k.. '~⪼ '..(info.username or '')..' » ❪`' ..v.. '`❫ \n'
else
message = message ..k.. '~⪼ '..(info.username or '')..' l » ❪`' ..v.. '`❫ \n'
...
message = message..'*┄─┅══┅─┄ \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(allam..'owners:'..msg.chat_id_)
if #list == 0 then  
...
if redis:sismember(allam..'gban_users',User) then 
return true 
else
return false
end 
...
if redis:sismember(allam..':Filter_Word:'..msg.chat_id_,word) then 
...
redis:setex(allam..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(allam..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(allam..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..allam..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(max..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(allam..'group:name'..GroupS) or '')
...
local owner = redis:smembers(allam..'owners:'..GroupS)
if #owner ~= 0 then
...
redis:del(
allam..'group:add'..id_group,
allam..'lock_link'..id_group, 
allam..'lock_id'..id_group,
allam..'lock_spam'..id_group, 
allam..'lock_webpage'..id_group,
allam..'lock_markdown'..id_group,
allam..'lock_flood'..id_group,
allam.'lock_bots'..id_group,
allam..'mute_forward'..id_group,
allam..'mute_contact'..id_group,
allam..'mute_location'..id_group,
allam..'mute_document'..id_group,
allam..'mute_keyboard'..id_group,
allam..'mute_game'..id_group,
allam..'mute_inline'..id_group,
allam..'lock_username'..id_group,
allam..'num_msg_max'..id_group,
allam..'replay'..id_group
)
...
redis:hset(allam..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(allam..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(allam..'group:add'..msg.chat_id_) then  return '🎗*│*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
local GroupUsers = tonumber(redis:get(allam..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(allam..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(allam..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
allam..'group:add'..msg.chat_id_,true,
allam..'lock_link'..msg.chat_id_,true, 
allam..'lock_id'..msg.chat_id_,true,
allam..'lock_spam'..msg.chat_id_,true,
allam..'lock_webpage'..msg.chat_id_,true,
allam..'lock_markdown'..msg.chat_id_,true,
allam..'lock_flood'..msg.chat_id_,true,
...
allam..'mute_keyboard'..msg.chat_id_,true,
allam..'mute_game'..msg.chat_id_,true,
allam..'mute_inline'..msg.chat_id_,true,
allam..'lock_username'..msg.chat_id_,true,
allam..'num_msg_max'..msg.chat_id_,5, 
allam..'replay'..msg.chat_id_,true
)

redis:sadd(allam..'group:ids',msg.chat_id_) 
redis:sadd(allam..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)
...
redis:set(allam..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(allam..'group:add'..msg.chat_id_) then return '🛠*│* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(allam..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(allam..'username:'..UserID,'username',Resolv)
redis:sadd(allam..':MONSHA_BOT:'..ChatID,UserID)
...
redis:srem(allam..':MONSHA_BOT:'..ChatID,UserID)
...
redis:hset(allam..'username:'..UserID,'username',Resolv)
redis:sadd(allam..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(allam..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(allam..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(allam..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(allam..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(allam..'whitelist:'..ChatID,UserID)
...
if redis:sismember(allam..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..'owners:'..ChatID,UserID)
...
if redis:sismember(allam..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(allam..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(allam..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(allam..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(allam..'admins:'..ChatID,UserID)
...
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم حظره  \n✓️',17,USERCAR) 
end
end)
...
redis:srem(allam..'banned:'..ChatID,UserID)
...
if redis:sismember(allam..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(allam..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(allam..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(allam..'username:'..UserID, 'username',Resolv)
redis:sadd(allam..'gban_users',UserID)
...
redis:srem(allam..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(allam..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(allam..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(allam..':SUDO_BOT:',UserID)
...
redis:hset(allam..'username:'..UserID, 'username', UserName)
redis:sadd(allam..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎟*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end

if cmd == "remmnsha" then
if not redis:sismember(allam..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎟*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*انه بالتأكيد ليس منشىء \n✓️') 
end
redis:srem(allam..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(allam..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎫*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(allam..'username:'..UserID, 'username', Resolv)
redis:sadd(allam..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
...
if cmd == "dn_sudo" then
if not redis:sismember(allam..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » '..USERNAME..' \n🎫*│* الايدي » (`'..UserID..'`)\n💯*╽*انه بالتأكيد ليس مطور \n✓') end
redis:srem(allam..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(allam..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(allam..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(allam..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(allam..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾*` اعدادات المجموعه :` \n"
.."\n📝╿التعديل «» "..(redis:get(allam..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗│الروابط «» "..(redis:get(allam..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣│التاك «» "..(redis:get(allam..'lock_tag'..msg.chat_id_) or 'false')
.."\n🐞│المعرفات «» "..(redis:get(allam..'lock_username'..msg.chat_id_) or 'false')
.."\n💱│التكرار «» "..(redis:get(allam..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑│الكلايش «» "..(redis:get(allam..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐│الويب «» "..(redis:get(allam..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️│الماركدوان «» "..(redis:get(allam..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻│بالطرد البوتات «» "..(redis:get(allam..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖│البوتات «» "..(redis:get(allam..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕│عدد التكرار «» "..(redis:get(allam..'num_msg_allam'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬│`اعدادات الوسائط :`\n"
.."\n*🎑│*المتحركه «» "..(redis:get(allam..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭│الدردشه «» "..(redis:get(allam..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️│الانلاين «» "..(redis:get(allam..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮│الالعاب «» "..(redis:get(allam..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞│الصور «» "..(redis:get(allam..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥│الفيديو «» "..(redis:get(allam..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙│البصمات «» "..(redis:get(allam..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉│الصوت «» "..(redis:get(allam..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎│الملصقات «» "..(redis:get(allam..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞│الجهات «» "..(redis:get(allam..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱│التوجيه «» "..(redis:get(allam..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐│الموقع «» "..(redis:get(allam..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂│الملفات «» "..(redis:get(allam..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅│الاشعارات «» "..(redis:get(allam..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒│الكيبورد «» "..(redis:get(allam..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒│*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️│*الترحيب «» "..welcomex
.."\n*💬│*الردود «» "..replayx
...
.."\n*🌐│*الويب «» "..(redis:get(allam..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚜️│*الماركدوان «» "..(redis:get(allam..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*🏌🏻│*البوتات بالطرد «» "..(redis:get(allam..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*🤖│*البوتات «» "..(redis:get(allam..'lock_bots'..msg.chat_id_) or 'false')
.."\n*➕╽*عدد التكرار «» "..(redis:get(allam..'num_msg_allam'..msg.chat_id_) or 'false')
.."\n┄─┅═ـ═┅─┄\n*👨‍💻*اعدادات التقـييد :\n"
.."\n*💢╿*التقييد بالتوجيه «» "..(redis:get(allam..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸│*التقييد بالصور «» "..(redis:get(allam..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗│*التقييد بالروابط «» "..(redis:get(allam..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉│*التقييد بالمتحركه «» "..(redis:get(allam..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥╽*التقييد الفيديو «» "..(redis:get(allam..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
