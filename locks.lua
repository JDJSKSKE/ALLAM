...
if redis:get(allam..'lock_woring'..msg.chat_id_) then 
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(allam..'lock_woring'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*التحذير بالتأكيد معطل\n✓" 
else
redis:del(allam..'lock_woring'..msg.chat_id_) 
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(allam..'lock_id'..msg.chat_id_) then 
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(allam..'lock_id'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*امر الايدي شغال بالفعل\n✓" 
else 
redis:set(allam..'lock_id'..msg.chat_id_,true)  
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(allam..'welcome:get'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تفعيل الترحيب مفعل مسبقاً\n✓" 
else redis:set(allam..'welcome:get'..msg.chat_id_,true)  
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(allam..'welcome:get'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*الترحيب بالتأكيد معطل\n✓" 
else
redis:del(allam..'welcome:get'..msg.chat_id_) 
...
redis:mset(
allam..'lock_username'..msg.chat_id_,true,
allam..'mute_gif'..msg.chat_id_,true,
allam..'mute_photo'..msg.chat_id_,true,
allam..'mute_audio'..msg.chat_id_,true,
allam..'mute_voice'..msg.chat_id_,true,
allam..'mute_sticker'..msg.chat_id_,true,
allam..'mute_forward'..msg.chat_id_,true,
allam..'mute_contact'..msg.chat_id_,true,
allam..'mute_location'..msg.chat_id_,true,
allam..'mute_document'..msg.chat_id_,true,
allam..'lock_link'..msg.chat_id_,true,
allam..'lock_tag'..msg.chat_id_,true,
allam..'lock_edit'..msg.chat_id_,true,
allam..'lock_spam'..msg.chat_id_,true,
allam..'lock_bots'..msg.chat_id_,true,
allam..'lock_webpage'..msg.chat_id_,true,
allam..'mute_video'..msg.chat_id_,true,
allam..'mute_inline'..msg.chat_id_,true
)
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تــ✓ــم قفل الكل  \n✓"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:del(
allam..'lock_username'..msg.chat_id_,
allam..'mute_gif'..msg.chat_id_,
allam..'mute_photo'..msg.chat_id_,
allam..'mute_audio'..msg.chat_id_,
allam..'mute_voice'..msg.chat_id_,
allam..'mute_sticker'..msg.chat_id_,
allam..'mute_forward'..msg.chat_id_,
allam..'mute_contact'..msg.chat_id_,
allam..'mute_location'..msg.chat_id_,
allam..'mute_document'..msg.chat_id_,
allam..'lock_link'..msg.chat_id_,
allam..'lock_tag'..msg.chat_id_,
allam..'lock_edit'..msg.chat_id_,
allam..'lock_spam'..msg.chat_id_,
allam..'lock_bots'..msg.chat_id_,
allam..'lock_webpage'..msg.chat_id_,
allam..'mute_video'..msg.chat_id_,
allam..':tqeed_video:'..msg.chat_id_,
allam..':tqeed_photo:'..msg.chat_id_,
allam..':tqeed_gif:'..msg.chat_id_,
allam..':tqeed_fwd:'..msg.chat_id_,
allam..':tqeed_link:'..msg.chat_id_,
allam..'mute_inline'..msg.chat_id_
)
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تــ✓ــم فتح الكل  \n✓"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(allam..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(allam..'mute_photo'..msg.chat_id_)
redis:set(allam..':tqeed_photo:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(allam..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..':tqeed_photo:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(allam..':tqeed_video:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالفيديو بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(allam..':tqeed_video:'..msg.chat_id_)
redis:set(allam..':tqeed_video:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(allam..':tqeed_video:'..msg.chat_id_) then
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(allam..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد الممتحركه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(allam..'mute_gif'..msg.chat_id_)
redis:set(allam..':tqeed_gif:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(allam..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد المتحركه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..':tqeed_gif:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(allam..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالتوجيه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(allam..'mute_forward'..msg.chat_id_)
redis:set(allam..':tqeed_fwd:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(allam..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد التوجيه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..':tqeed_fwd:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(allam..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..':tqeed_link:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(allam..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..':tqeed_link:'..msg.chat_id_)
...
if redis:get(allam..'lock_twasel') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التواصل بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:set(allam..'lock_twasel',true)
...
if not msg.SudoBase then return "🚸*│*هذا الامر يخص المطور الاساسي فقط  \n💥" end
if not redis:get(allam..'lock_twasel') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التواصل بالتاكيد تــ✓ــم تفعيله \n✓'
else 
redis:del(allam..'lock_twasel')
...
if not redis:get(allam..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:del(allam..'replay'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تفعيله \n✓'
else 
redis:set(allam..'replay'..msg.chat_id_,true)
...
if not msg.SudoBase then return "🚸*│*هذا الامر يخص المطور الاساسي فقط  \n💥" end
if not redis:get(allam..'lock_service') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم بالتاكيد تعطيل نظام البوت خدمي \n✓'
else
redis:del(allam..'lock_service')
...
if not msg.SudoBase then return "🚸*│*هذا الامر يخص المطور الاساسي فقط  \n💥" end
if redis:get(allam..'lock_service') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم بالتأكيد تفعيل نظام البوت خدمي \n✓'
else 
redis:set(allam..'lock_service',true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'lock_link'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'lock_link'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك (#) بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'lock_tag'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التاك (#) \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك(#) بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'lock_tag'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التاك (#) \n✓'
end
end
---------------Lock UserName-------------------
...
if redis:get(allam..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المعرفات @ بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'lock_username'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*آلمـعرفآت بآلتآگيد تــ✓ــم فتحهآ @ \n✓'
else 
redis:del(allam..'lock_username'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'lock_edit'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'lock_edit'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(allam..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'lock_spam'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'lock_spam'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'lock_flood'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'lock_flood'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'lock_bots'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'lock_bots_by_kick'..msg.chat_id_)
redis:del(allam..'lock_bots'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'lock_join'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'lock_join'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'lock_markdown'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'lock_markdown'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'lock_webpage'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الويب \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'lock_webpage'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الويب \n✓'
end
end
---------------Mute Gif-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_gif'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المتحركه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_gif'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_gif'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_game'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_game'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الألعاب بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_game'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الألعاب \n✓'
end
end
---------------Mute Inline-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'mute_inline'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'mute_inline'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدرشه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الدردشه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدردشه بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الدردشه \n✓'
end
end
---------------Mute photo-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_photo'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصور بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_photo'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصور \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_photo'..msg.chat_id_)then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_video'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الفيديو \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو يال��أكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_video'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الفيديو \n✓'
end
end
---------------Mute Audio-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_audio'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البصمات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_audio'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البصمات \n✓'
end
end
---------------Mute Voice-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(allam..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'mute_voice'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصوت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'mute_voice'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الصوت \n✓'
end
end
---------------Mute Sticker-------------------
...
if   redis:get(allam..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_sticker'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_sticker'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_contact'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_contact'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_forward'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التوجيه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_forward'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التوجيه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_forward'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(allam..'mute_location'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الموقع \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'mute_location'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الموقع \n✓'
end
end
---------------Mute Document-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(allam..'mute_document'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الملفات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_document'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الملفات \n✓'
end
end
---------------Mute TgService-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'mute_tgservice'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_tgservice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاشعارات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(allam..'mute_tgservice'..msg.chat_id_)
...
redis:set(allam..'mute_keyboard'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(allam..'mute_keyboard'..msg.chat_id_)
...
redis:set(allam..'lock_bots'..msg.chat_id_,true)
redis:set(allam..'lock_bots_by_kick'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_bots_by_kick'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(allam..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مقفل \n✓'
else
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(allam..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مفتوح \n✓'
else 
redis:del(allam..'lock_pin'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم فتح التثبيت   \n✓'
end
end
